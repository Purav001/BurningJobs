...
const Header = () => {
  ...
  return (
      ...
      //       </ul>
      //     </div>
      //     <a href='/'  className="btn btn-ghost text-xl">Burning Jobs</a>
      //   </div>
      ...
      // </div>
      <header >
        <nav className="bg-[#1b2528] border-gray-200 padding-global py-3">
          <div className="flex flex-wrap justify-between items-center" >
              <a href="https://flowbite.com" className="flex items-center">
                  <img src="https://flowbite.com/docs/images/logo.svg" className="mr-3 h-6 sm:h-9" alt="Flowbite Logo" />
                  <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Burning Jobs</span>
              </a>
